...
template<>
void shader_t::set_uniform<unsigned int>(const std::string& name, unsigned int val) {
    glUniform1i(glGetUniformLocation(program_id_, name.c_str()), val);
}
...
void shader_t::set_vec2(const std::string& name, const glm::vec2& value) const {
...
void shader_t::set_vec3(const std::string& name, const glm::vec3& value) const {
...
void shader_t::set_vec4(const std::string& name, const glm::vec4& value) const {
    glUniform4fv(glGetUniformLocation(program_id_, name.c_str()), 1, &value[0]);
}
void shader_t::set_vec4(const std::string& name, float x, float y, float z, float w) const {
    glUniform4f(glGetUniformLocation(program_id_, name.c_str()), x, y, z, w);
}
void shader_t::set_mat2(const std::string& name, const glm::mat2& mat) const {
    glUniformMatrix2fv(glGetUniformLocation(program_id_, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}
void shader_t::set_mat3(const std::string& name, const glm::mat3& mat) const {
    glUniformMatrix3fv(glGetUniformLocation(program_id_, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}
void shader_t::set_mat4(const std::string& name, const glm::mat4& mat) const {
